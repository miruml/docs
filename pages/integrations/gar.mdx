...
import AddTokenCreatorRole from '/snippets/integrations/gar/add-token-creator-role.mdx'
...
<AccordionGroup>
  ...
  <Accordion icon = 'lock' title = 'Add the Service Token Creator Role' id = 'add-token-creator-role'>
  <AddTokenCreatorRole/>
  </Accordion> 
