...
This is **NOT a tutorial** detailing the installation and usage of Miru in depth. For detailed instructions, refer to the [getting started](/pages/getting-started/install-cli) guide (after reading through these core concepts). 
