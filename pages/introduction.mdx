...
- **Hardware Variability**: Hardware variants use configurations to set the appropriate software dependencies and functionalities supported by the hardware.
...
Robots often require unique configurations for each unit, such as calibrations for end effectors or exposure settings for cameras. 
...
If you're ready to get started, we still recommend reading through the [core concepts](/pages/core-concepts) before following the [getting started](/pages/getting-started) guide.
