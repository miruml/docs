...
If you're ready to start using Miru, still begin with the [core concepts](/pages/core-concepts) before following the [getting started](/pages/getting-started) guide.
