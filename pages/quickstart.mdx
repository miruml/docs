...
import VerifyDeployment from '/snippets/get-started/deploy-artifact/verify-dep.mdx';
import UsingDeployments from '/snippets/get-started/deploy-artifact/using-deps.mdx';
...
<AccordionGroup>
  ...
  <Accordion icon="magnifying-glass" title="Verify Deployment" id = 'verify-deployment'>
    <VerifyDeployment />
  </Accordion>
