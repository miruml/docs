...
func (s *ComposeFileAPIService) WorkspaceWorkspaceIdComposeVerifyPost(ctx context.Context, verifyComposeFile VerifyComposeFile) (ImplResponse, error) {
	...
	// TODO: Uncomment the next line to return response Response(200, VerifiedComposeFileResponse{}) or use other options such as http.Ok ...
	// return Response(200, VerifiedComposeFileResponse{}), nil
