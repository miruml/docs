...
func (r ApiGroupsGroupIdGetRequest) Execute() (*Group, *http.Response, error) {
	return r.ApiService.GroupsGroupIdGetExecute(r)
}

/*
GroupsGroupIdGet Method for GroupsGroupIdGet
...
//  @return Group
func (a *GroupsAPIService) GroupsGroupIdGetExecute(r ApiGroupsGroupIdGetRequest) (*Group, *http.Response, error) {
	var (
