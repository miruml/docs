...
func (r ApiWorkspaceWorkspaceIdComposeVerifyPostRequest) Execute() (*VerifyComposeFileResponse, *http.Response, error) {
...
//  @return VerifyComposeFileResponse
func (a *ComposeFileAPIService) WorkspaceWorkspaceIdComposeVerifyPostExecute(r ApiWorkspaceWorkspaceIdComposeVerifyPostRequest) (*VerifyComposeFileResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *VerifyComposeFileResponse
	)
