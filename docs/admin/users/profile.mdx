...
<Frame>
  ![](https://assets.mirurobotics.com/docs/v03/images/users/profile/main.png)
</Frame>
...
<Frame>
  ![](https://assets.mirurobotics.com/docs/v03/images/users/profile/set-avatar-dropdown.png)
</Frame>

Select the image you want to use from the file system. A dialog will appear, allowing you to crop the image.

<Frame>
  ![](https://assets.mirurobotics.com/docs/v03/images/users/profile/crop-avatar.png)
</Frame>
...
<Frame>
  ![](https://assets.mirurobotics.com/docs/v03/images/users/profile/remove-avatar-dropdown.png)
</Frame>
