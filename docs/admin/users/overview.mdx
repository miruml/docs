...
<Framed background="https://assets.mirurobotics.com/docs/v02/images/users/background.jpeg" image="https://assets.mirurobotics.com/docs/v02/images/users/members/header:page.png" borderWidth={"24px 0 0 40px"} innerRadius={"8px 0 0 0"} />
