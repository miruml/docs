...
<Framed background="https://assets.miruml.com/docs/v02/images/users/background.jpeg" image="https://assets.miruml.com/docs/v02/images/users/members/header:page.png" borderWidth={"24px 0 0 40px"} innerRadius={"8px 0 0 0"} />
...
<ParamField path="role">
  ...
  The user's [access role](/docs/admin/users/overview#roles) in the workspace.
