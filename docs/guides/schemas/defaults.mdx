...
As detailed further down in the [extracting defaults](/docs/guides/schemas/defaults#extracting-defaults) section, Miru integrates directly with schema defaults to auto-populate config instances.
