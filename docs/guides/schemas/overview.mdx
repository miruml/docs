...
<ImageOverlay
  baseImage="/images/background.jpeg"
  overlayImage="/images/config-schemas/header:panel.png"
...
Miru supports the following schema languages:

- [JSON Schema](https://json-schema.org/draft/2020-12) (draft 2020-12)
- [CUE](https://cuelang.org/)

For information on integration with Miru, supported features, strengths, and limitations of a given schema language, visit the [languages](/docs/guides/schemas/languages/jsonschema) section of this guide.

If you're deciding what language to use, check out our blog post comparing JSON Schema, CUE, and Protocol Buffers: [Config Wars](https://blog.miruml.com/p/config-wars-chapter-1-intro-to-schemas?utm_source=publication-search).
