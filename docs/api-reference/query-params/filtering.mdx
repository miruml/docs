...
For example, when [listing devices](https://docs.miruml.com/docs/api-reference/query-params/filtering), you can filter by `id`, `name`, and other fields.
...
Filtering by id will return at most one resource, since IDs are unique. Other fields, like [config instance activity status](https://docs.miruml.com/docs/api-reference/query-params/filtering), can return multiple results.
## Multi-Value Filters
