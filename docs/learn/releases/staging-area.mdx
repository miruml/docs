...
<Framed 
  background="https://assets.miruml.com/docs/v02/images/releases/background.jpeg"
  image="https://assets.miruml.com/docs/v02/images/releases/stage/header:page.png"
...
Deployments in the staging area can be freely created *before* being deployed to devices, making it an ideal place to prepare and review deployments before rolling them out.
...
<Frame>
  ![](https://assets.miruml.com/docs/v02/images/releases/page.png)
</Frame>

Then select the **Stage** tab at the top of the page.

<Frame>
  ![](https://assets.miruml.com/docs/v02/images/releases/stage/page.png)
</Frame>
...
Only one deployment may be staged for a device at a time. If a release already has a deployment staged for a device, staging a new deployment will replace the existing deployment.
 
To stage a deployment, click the **Stage Deployment** button in the top right. 

<Frame>
  ![](https://assets.miruml.com/docs/v02/images/releases/stage/stage-dialog-step1:configs.png)
</Frame>
...
<Frame>
  ![](https://assets.miruml.com/docs/v02/images/releases/stage/stage-dialog-step1:description.png)
</Frame>
...
<Frame>
  ![](https://assets.miruml.com/docs/v02/images/releases/stage/stage-dialog-step2:select-devices.png)
</Frame>
...
<Frame>
  ![](https://assets.miruml.com/docs/v02/images/releases/stage/stage-dialog-step2:click-stage.png)
</Frame>
...
<Frame>
  ![](https://assets.miruml.com/docs/v02/images/deployments/staged-panel.png)
</Frame>
...
<Frame>
  ![](https://assets.miruml.com/docs/v02/images/deployments/staged-panel:configurations.png)
</Frame>
...
<Tabs>
  <Tab title="Content">
    <Frame>
      ![](https://assets.miruml.com/docs/v02/images/config-instances/panel-content:staged.png)
    </Frame>
  </Tab>
  <Tab title="Metadata">
    <Frame>
      ![](https://assets.miruml.com/docs/v02/images/config-instances/panel-metadata:staged.png)
    </Frame>
  </Tab>
</Tabs>
...
Patching a deployment is the process of creating a new deployment to take the place of an existing deployment. Patching explicitly marks the original deployment as the parent of the new deployment, making it easy to trace the history of changes for a device's configurations.
...
<Frame>
  ![](https://assets.miruml.com/docs/v02/images/releases/stage/ellipses-dropdown:staged.png)
</Frame>

A dialog will appear with the original deployment's config instances populated in each tab. 

<Frame>
  ![](https://assets.miruml.com/docs/v02/images/releases/stage/patch-dialog:configurations.png)
</Frame>
...
<Frame>
  ![](https://assets.miruml.com/docs/v02/images/releases/stage/patch-dialog:description.png)
</Frame>
...
<Frame>
  ![](https://assets.miruml.com/docs/v02/images/releases/stage/archive-dialog:single.png)
</Frame>

**Multiple Deployments**

To archive multiple deployments, hover over the deployments you want to archive and select the checkbox on the far left of the deployment.

<Frame>
  ![](https://assets.miruml.com/docs/v02/images/releases/stage/select-devices.png)
</Frame>

At the bottom of the page, click **Archive** from the available bulk actions.

<Frame>
  ![](https://assets.miruml.com/docs/v02/images/releases/stage/bulk-actions.png)
</Frame>

A confirmation dialog will appear. Hit **Archive** to confirm. 

<Frame>
  ![](https://assets.miruml.com/docs/v02/images/releases/stage/archive-dialog:bulk.png)
</Frame>
...
To deploy one or more deployments, hover over the deployments you want to deploy and select their checkboxes on the far left of the page.
...
<Frame>
  ![](https://assets.miruml.com/docs/v02/images/releases/stage/deploy-dialog:bulk.png)
</Frame>
...
![](https://assets.miruml.com/docs/v02/images/deployments/deployment-drift.png)
...
<Frame>
  ![](https://assets.miruml.com/docs/v02/images/releases/stage/ellipses-dropdown:drifted.png)
</Frame>
...
<Frame>
  ![](https://assets.miruml.com/docs/v02/images/releases/stage/review-dialog:deployments.png)
</Frame>

Clicking into a deployment will open the deployment details panel on the right of the page. 

<Frame>
  ![](https://assets.miruml.com/docs/v02/images/releases/stage/deployment-panel:deployed.png)
</Frame>

Clicking into the deployment's listed configurations will open that config instance's details panel with the differences highlighted.

<Frame>
  ![](https://assets.miruml.com/docs/v02/images/releases/stage/config-panel.png)
</Frame>

With the deployment's patches available to view, you have two options to proceed.
...
<Frame>
  ![](https://assets.miruml.com/docs/v02/images/releases/stage/review-dialog:restage.png)
</Frame>
...
<Frame>
  ![](https://assets.miruml.com/docs/v02/images/releases/stage/review-dialog:archive.png)
</Frame>
