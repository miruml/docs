...
<Frame>
  ![](https://assets.mirurobotics.com/docs/v03/images/releases/stage/page.png)
</Frame>
...
<Frame>
  ![](https://assets.mirurobotics.com/docs/v03/images/releases/stage/stage-dialog-step1:configs.png)
</Frame>
...
<Frame>
  ![](https://assets.mirurobotics.com/docs/v03/images/releases/stage/stage-dialog-step1:description.png)
</Frame>
...
<Frame>
  ![](https://assets.mirurobotics.com/docs/v03/images/releases/stage/stage-dialog-step2:select-devices.png)
</Frame>
...
<Frame>
  ![](https://assets.mirurobotics.com/docs/v03/images/releases/stage/stage-dialog-step2:click-stage.png)
</Frame>
...
<Frame>
  ![](https://assets.mirurobotics.com/docs/v03/images/deployments/staged-panel.png)
</Frame>
...
<Frame>
  ![](https://assets.mirurobotics.com/docs/v03/images/deployments/staged-panel:configurations.png)
</Frame>
...
<Tabs>
  <Tab title="Content">
    <Frame>
      ![](https://assets.mirurobotics.com/docs/v03/images/config-instances/panel-content:staged.png)
    </Frame>
  </Tab>
  <Tab title="Metadata">
    <Frame>
      ![](https://assets.mirurobotics.com/docs/v03/images/config-instances/panel-metadata:staged.png)
    </Frame>
  </Tab>
</Tabs>
...
<Frame>
  ![](https://assets.mirurobotics.com/docs/v03/images/releases/stage/ellipses-dropdown:staged.png)
</Frame>

A dialog will appear with the original deployment's config instances populated in each tab.

<Frame>
  ![](https://assets.mirurobotics.com/docs/v03/images/releases/stage/patch-dialog:configurations.png)
</Frame>
...
<Frame>
  ![](https://assets.mirurobotics.com/docs/v03/images/releases/stage/patch-dialog:description.png)
</Frame>
...
<Frame>
  ![](https://assets.mirurobotics.com/docs/v03/images/releases/stage/archive-dialog:single.png)
</Frame>
...
<Frame>
  ![](https://assets.mirurobotics.com/docs/v03/images/releases/stage/select-devices.png)
</Frame>

At the bottom of the page, click **Archive** from the available bulk actions.

<Frame>
  ![](https://assets.mirurobotics.com/docs/v03/images/releases/stage/bulk-actions.png)
</Frame>

A confirmation dialog will appear--hit **Archive** to confirm.

<Frame>
  ![](https://assets.mirurobotics.com/docs/v03/images/releases/stage/archive-dialog:bulk.png)
</Frame>
...
<Frame>
  ![](https://assets.mirurobotics.com/docs/v03/images/releases/stage/deploy-dialog:bulk.png)
</Frame>
...
![](https://assets.mirurobotics.com/docs/v03/images/deployments/deployment-drift.png)
...
<Frame>
  ![](https://assets.mirurobotics.com/docs/v03/images/releases/stage/ellipses-dropdown:drifted.png)
</Frame>
...
<Frame>
  ![](https://assets.mirurobotics.com/docs/v03/images/releases/stage/review-dialog:deployments.png)
</Frame>

Clicking a deployment opens the deployment details panel on the right side of the page.

<Frame>
  ![](https://assets.mirurobotics.com/docs/v03/images/releases/stage/deployment-panel:deployed.png)
</Frame>

Clicking a deployment's listed configuration opens that config instance's details panel, with the differences highlighted.

<Frame>
  ![](https://assets.mirurobotics.com/docs/v03/images/releases/stage/config-panel.png)
</Frame>
...
<Frame>
  ![](https://assets.mirurobotics.com/docs/v03/images/releases/stage/review-dialog:restage.png)
</Frame>
...
<Frame>
  ![](https://assets.mirurobotics.com/docs/v03/images/releases/stage/review-dialog:archive.png)
</Frame>
