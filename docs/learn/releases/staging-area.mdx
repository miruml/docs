...
Make any desired edits to the deployment's config instances. Once satisfied with the edits, enter a description at the bottom of the dialog and hit **Stage**.
