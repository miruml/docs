...
Furthermore, the CLI can be used to programmatically create releases in a [CI pipeline](/docs/learn/releases/ci), ensuring releases contain the correct schemas and are always associated with the correct Git commit.
