...
<Framed background="https://assets.mirurobotics.com/docs/v02/images/releases/background.jpeg" image="/images/releases/header:release-create.png" borderWidth="28px" />
