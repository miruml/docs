...
The only method of creating releases is via the command line. 
...
For a concise overview of setting up a CI pipeline for releases, continue reading below. For more detailed CI information, visit the [CI documentation](/docs/developers/ci/overview).
