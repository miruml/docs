...
Begin by cloning the [custom-validation](https://github.com/mirurobotics/custom-validation) repository.

```
git clone https://github.com/mirurobotics/custom-validation.git
```
...
To trigger a real webhook, you'll need to deploy a config instance to a device. To do this, navigate to the [Devices](https://app.mirurobotics.com/devices) page in Miru.
