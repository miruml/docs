...
This section guides you through the process of integrating an endpoint with Miru. An example [Flask server](https://github.com/mirurobotics/custom-validation), which leverages the [Miru server-side SDK](/docs/references/server-side-api/sdks/python), is provided to get you started.

You may host the endpoint however you'd like as long as it is accessible over HTTPS.

If want to set up a server on your local machine for testing or want a more in-depth walkthrough of the process, skip this section in favor of the the [Local Testing](/docs/learn/custom-validation/local-testing) section.
...
To enable custom validation for a release, navigate to the [Releases](https://app.mirurobotics.com/releases) page. Click the ellipses on the far right of the release you would like to enable and select **Edit** from the dropdown.

<Frame>
  ![](https://assets.mirurobotics.com/docs/v02/images/releases/enable-custom-val-dialog.png)
</Frame>
...
Navigate to the [webhooks](https://app.mirurobotics.com/webhooks) page in Miru.

<Frame>
  ![](https://assets.mirurobotics.com/docs/v02/images/webhooks/header.png)
</Frame>
...
<Frame>
  ![](https://assets.mirurobotics.com/docs/v02/images/webhooks/create-endpoint.png)
</Frame>
...
<Frame>
  ![](https://assets.mirurobotics.com/docs/v02/images/webhooks/endpoint-page.png)
</Frame>
...
The [custom-validation](https://github.com/mirurobotics/custom-validation) repository contains an example Flask server that demonstrates webhook verification and deployment validation using the Miru server-side SDK.

### Secrets

For a plug-and-play experience with Webhook Secrets and API Keys, you may place the secrets in the [.env](https://github.com/mirurobotics/custom-validation/blob/main/.env) file. However, for production use, we recommend storing the secrets in a secrets manager or other secure location.

### Code walkthrough

The [app.py](https://github.com/mirurobotics/custom-validation/blob/main/flask/app.py) file is the entry point for the Flask server. Let's walk through it step by step.
