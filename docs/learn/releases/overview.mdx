...
<Framed 
  ...
  image="https://assets.miruml.com/docs/v02/images/releases/header:page.png"
...
The [config schemas](/docs/learn/schemas/overview#properties) which define compatible config instances for the release.
