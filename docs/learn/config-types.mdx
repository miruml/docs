...
<Frame>
  ![](https://assets.mirurobotics.com/docs/v03/images/config-types/ellipses-dropdown.png)
</Frame>

Update the desired fields, then click **Save**.

<Frame>
  ![](https://assets.mirurobotics.com/docs/v03/images/config-types/edit-dialog.png)
</Frame>
...
<Frame>
  ![](https://assets.mirurobotics.com/docs/v03/images/config-types/delete-dialog.png)
</Frame>