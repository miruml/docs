...
<Framed image="https://assets.mirurobotics.com/docs/v02/images/config-types/header:page.png" background="https://assets.mirurobotics.com/docs/v02/images/config-types/background.jpeg" borderWidth="24px 0 0 32px" innerRadius="8px 0 0 0" />
...
<Frame>
  ![](https://assets.mirurobotics.com/docs/v02/images/config-types/ellipses-dropdown.png)
</Frame>

Update the desired fields, then click **Save**.

<Frame>
  ![](https://assets.mirurobotics.com/docs/v02/images/config-types/edit-dialog.png)
</Frame>
...
<Frame>
  ![](https://assets.mirurobotics.com/docs/v02/images/config-types/delete-dialog.png)
</Frame>