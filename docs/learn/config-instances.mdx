...
The origin tracks the initial deployment that created the config instance while the owner tracks the current deployment that the config instance belongs to.
