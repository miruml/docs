...
<Framed background="https://assets.miruml.com/docs/v02/images/config-instances/background.jpeg" image="https://assets.miruml.com/docs/v02/images/config-instances/header:panel.png" borderWidth="28px 56px 0 0" innerRadius="0 8px 0 0" />
