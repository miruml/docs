...
<Framed background="https://assets.mirurobotics.com/docs/v02/images/config-instances/background.jpeg" image="https://assets.mirurobotics.com/docs/v02/images/config-instances/header:panel.png" borderWidth="28px 56px 0 0" innerRadius="0 8px 0 0" />
...
<ParamField path="status" type="string">
  ...
  This property merges the `activity status` and `error status` fields, with error states taking precedence over activity states when errors are present.
...
<ParamField path="device" type="Device">
  ...
  The device to which the config instance is deployed.
...
![](https://assets.mirurobotics.com/docs/v02/images/config-instances/ownership:step1.png)
...
After our initial deployment, we decided to make an edit to the `Mobility` config instance, creating `DPL-8Xerr` to replace `DPL-MT3Ec`.

![](https://assets.mirurobotics.com/docs/v02/images/config-instances/ownership:step2.png)
...
![](https://assets.mirurobotics.com/docs/v02/images/config-instances/ownership:step3.png)
