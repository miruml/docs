...
<Framed 
  ...
  image="https://assets.miruml.com/docs/v02/images/devices/header:list.png"
...
The [release](/docs/learn/releases/overview#properties) that the device's current deployment belongs to.
...
![](https://assets.miruml.com/docs/v02/images/devices/status-fsm.png)
...
<Frame>
  ![](https://assets.miruml.com/docs/v02/images/devices/status-hover.png)
</Frame>
