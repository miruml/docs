...
<Framed background="https://assets.miruml.com/docs/v02/images/devices/background.jpeg" image="https://assets.miruml.com/docs/v02/images/devices/deployments/header:page.png" borderWidth={"24px 30px 0 30px"} innerRadius={"12px 12px 0 0"} outerRadius="14px" />
