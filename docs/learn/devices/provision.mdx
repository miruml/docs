...
<Framed background="https://assets.miruml.com/docs/v02/images/devices/background.jpeg" image="https://assets.miruml.com/docs/v02/images/devices/header:create-panel.png" borderWidth={"36px 100px 0 0"} innerRadius={"0 8px 0 0"} />
...
<Frame>
  ![](https://assets.miruml.com/docs/v02/images/agent/github-assets.png)
</Frame>
