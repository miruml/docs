...
<Framed 
  ...
  image="https://assets.miruml.com/docs/v02/images/devices/header:create-panel.png"
...
Without this flag, only `inactive` devices can be activated. With this flag, devices which have been previously activated (status `online`, `offline`, etc.) may be reactivated.
