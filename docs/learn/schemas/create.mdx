...
<Framed background="https://assets.miruml.com/docs/v02/images/config-schemas/background.png" image="https://assets.miruml.com/docs/v02/images/config-schemas/header:schema-push.png" borderWidth="40px" />
...
It's important to reiterate that Miru does not directly integrate with your hosted git repository provider (GitHub, GitLab, Bitbucket, etc.). It only captures Git metadata from the local Git repository where the CLI is run.
