...
<Framed 
  ...
  image="https://assets.miruml.com/docs/v02/images/config-schemas/header:panel.png"
  borderWidth={"32px 56px 0 0"}
...
The [schema language](/docs/learn/schemas/languages) used to define the schema. 
...
Digests are computed by converting schemas to a canonical format--a format which disregards whitespace, comments, and other non-semantic differences--and hashing the result. This is useful for comparing schemas and detecting duplicates.
...
The [config type](/docs/learn/config-types#properties) which the schema belongs to.
...
For more information on schema languages, visit the [languages](/docs/learn/schemas/languages) section of this guide. 
...
<Frame>
  ![](https://assets.miruml.com/docs/v02/images/devices/editor/invalid-mobility-edit.png)
</Frame>
...
<Frame>
  ![](https://assets.miruml.com/docs/v02/images/devices/editor/invalid-mobility-err-msg.png)
</Frame>
...
<Frame>
  ![](https://assets.miruml.com/docs/v02/images/devices/editor/valid-mobility-edit.png)
</Frame>
