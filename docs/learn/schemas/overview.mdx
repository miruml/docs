...
However, each language supports a different set of file formats. Visit the [languages](/docs/learn/schemas/languages) section for more information about each language's supported file formats.
