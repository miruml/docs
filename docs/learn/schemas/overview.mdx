...
<Framed background="https://assets.miruml.com/docs/v02/images/config-schemas/background.png" image="https://assets.miruml.com/docs/v02/images/config-schemas/header:panel.png" borderWidth={"32px 56px 0 0"} innerRadius={"0 8px 0 0"} />
