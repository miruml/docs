...
<Update label="December 8, 2025" tags={["Agent"]}>
  ...
  **Improvements**
  - Installation script runs `sudo chown -R miru:miru /srv/miru` to prevent any permissions issues encountered if the `/srv/miru` directory has already been created with the wrong permissions
</Update>
...
<Update label="December 4, 2025" tags={["CLI"]}>
  ...
  **Features**
  - Added support for [CUE](/docs/guides/schemas/languages) schemas
