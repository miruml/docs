...
<Update label="December 19, 2025">
    ...
    <video
        ...
        src="https://assets.miruml.com/docs/changelog/25-12-19/upload-workspace-logo.mp4"
    />
    ...
    <video
        ...
        controls
        className="aspect-video rounded-xl"
        src="https://assets.miruml.com/docs/changelog/25-12-19/upload-profile-picture.mp4"
    />
    ...
    <video
        ...
        controls
        className="aspect-video rounded-xl"
        src="https://assets.miruml.com/docs/changelog/25-12-19/feedback-demo.mp4"
    />
