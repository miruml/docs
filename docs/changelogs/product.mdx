...
<Update label="November 10, 2025" description="v0.3">
    ...
    2. **Deploy configurations** - Either deploy a staged deployment or create and deploy new configurations
    ...
    <video
        ...
        src="https://miru-docs.s3.us-east-1.amazonaws.com/changelog/2025-11-10/setting-init-release.mp4"
    />
    ...
    When you change releases, you'll need todeploy a new set of configurations — either 
    a staged deployment or by creating a new deployment.
    ...
    <video
        ...
        controls
        className="aspect-video rounded-xl"
        src="https://miru-docs.s3.us-east-1.amazonaws.com/changelog/2025-11-10/changing-release.mp4"
    />
    ...
    <Dropdown title="Improvements">
        ...
        <DropdownItem>Added the config instance ID in the Config Instance sheet header</DropdownItem>
