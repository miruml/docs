...
<Update label="January 27, 2026">
    ...
    <Dropdown title="Improvements">
        <DropdownItem>
            **Track Git Metadata with Releases:** Releases are now associated with a specific Git commit and repository, allowing you to easily trace the release's origin.
        </DropdownItem>
    </Dropdown>
    <Separator />
    <Dropdown title="Fixes">
        <DropdownItem>
            **Show Full Cue Validation Errors:** Validation failures now display 
            the full CUE validation error message instead of masking larger error messages, making it easier to debug schema issues.
        </DropdownItem>
    </Dropdown>
</Update>
