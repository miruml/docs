...
This section is optional. However, you may find it useful to clone and run the server locally to test everything is working before deploying to a remote server.
