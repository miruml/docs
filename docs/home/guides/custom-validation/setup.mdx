...
1. Deploy an endpoint that validates [deployments](/docs/home/getting-started/concepts#deployments) for your application.
...
Custom validation is enabled on a per-[release](/docs/home/getting-started/concepts#release) basis. Enabling it on one release has no impact on other releases.
