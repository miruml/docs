...
The config instances are autopopulated with the default values from the release's config schemas. If you're taking the schemaless or don't include any defaults in your schema, the config instances will be empty.
...
To view the deployment for this device, navigate to the [Devices page](https://configs.miruml.com/devices) 

<Frame>
   ![](/images/devices/page.png)
</Frame>
