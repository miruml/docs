...
Select the [config schema](/docs/home/basics/vocabulary#config-schema) you want the new config instance to adhere to. The config instance is autopopulated with the default values from the schema. To edit the config instance beyond the defaults, click **Next**.
