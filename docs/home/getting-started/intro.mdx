...
<Columns cols={2}>
  <Card title="Quick Start" icon="rocket" href="/docs/home/getting-started/quick-start/setup">
...
To begin using Miru, continue to the [getting-started](/docs/home/basics/getting-started/overview) guide.