...
## Create a Client
Let's create a new [client](/docs/basics/vocabulary#client) by heading to the 
...
## Tag Types
Miru uses [tag types](/docs/basics/vocabulary#tag-types-%26-tags) to organize related tags that share a metadata schema.
