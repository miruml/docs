...
<View title="JSON Schema" icon="https://assets.miruml.com/docs/images/schema-langs/jsonschema/logo.svg">
...
<View title="CUE" icon="https://assets.miruml.com/docs/images/schema-langs/cue/logo.svg">
...
<Frame>
   ![](https://assets.miruml.com/docs/images/config-schemas/page.png)
</Frame>
