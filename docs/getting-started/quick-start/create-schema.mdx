...
<Tip>
  This guide defaults to JSON Schema. To follow along with another [schema language](/docs/learn/schemas/languages), select from the dropdown in the top right corner of this page.
</Tip>
