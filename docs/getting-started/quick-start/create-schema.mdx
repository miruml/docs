...
To keep things simple, we've provided a [getting-started repository](https://github.com/mirurobotics/getting-started) that contains a variety of sample schemas. Follow along with us by cloning the repository.
...
<Tabs>
  <Tab title="JSON Schema">
    - [Empty schema](https://github.com/mirurobotics/getting-started/blob/main/jsonschema/empty-mobility.yaml) - a schema that regards all config instances as valid
    - [Strict schema](https://github.com/mirurobotics/getting-started/blob/main/jsonschema/mobility.yaml) - a well-defined schema that constrains the valid fields, types, and values for instances of the `Mobility` config type
  ...
  <Tab title="CUE">
    - [Empty schema](https://github.com/mirurobotics/getting-started/blob/main/cue/empty-mobility.cue) - a schema that regards all config instances as valid
    - [Strict schema](https://github.com/mirurobotics/getting-started/blob/main/cue/mobility.cue) - a well-defined schema that constrains the valid fields, types, and values for instances of the `Mobility` config type
...
Before defining a schema, we first need to create a config type to house it. Navigate to the [config types page](https://app.mirurobotics.com/configs).

<Frame>
  ![](https://assets.mirurobotics.com/docs/v02/images/config-types/create-page.png)
</Frame>

Click the **New Config Type** button. Supply the name `Mobility` and slug `mobility`. Finally, click **Create**.

<Frame>
  ![](https://assets.mirurobotics.com/docs/v02/images/config-types/create-dialog.png)
</Frame>
...
Navigate to the root of the [getting-started](https://github.com/mirurobotics/getting-started) repository and push the mobility schema to Miru.
...
<Tabs>
  <Tab title="JSON Schema">
    ...
    🔍 Collected Git Metadata
        ...
        origin: git@github.com:mirurobotics/getting-started.git
...
To view the schema in Miru, navigate to the [config types page](https://app.mirurobotics.com/configs) and click into the `Mobility` config type.

<Frame>
  ![](https://assets.mirurobotics.com/docs/v02/images/config-schemas/page.png)
</Frame>

Clicking into a specific schema will show the schema details, including its metadata and the schema content.

<Frame>
  ![](https://assets.mirurobotics.com/docs/v02/images/config-schemas/panel.png)
</Frame>