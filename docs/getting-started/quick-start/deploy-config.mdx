...
To deploy a config instance, we need a software release to associate it with.

Begin by navigating to the [Releases page](https://app.miruml.com/releases) .
...
To view the deployment for this device, navigate to the [Devices page](https://app.miruml.com/devices).
