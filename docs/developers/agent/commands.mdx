...
<Tabs >
  <Tab title="Active">
    ...
    <Frame>
      ![](https://assets.miruml.com/docs/v02/images/agent/commands/systemctl-status:running.png)
    </Frame>
  </Tab>
  <Tab title="Inactive">
    ...
    <Frame>
      ![](https://assets.miruml.com/docs/v02/images/agent/commands/systemctl-status:dead.png)
    </Frame>
  </Tab>
</Tabs>
