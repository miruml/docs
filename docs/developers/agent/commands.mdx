...
The current [CLI](/docs/references/cli/intro) is only for managing Miru resources from your development machine's terminal. Please do not attempt to use the `miru` command to manage the agent.
...
<Tabs >
  <Tab title="Active">
    ...
    <Frame>
      ![](https://assets.mirurobotics.com/docs/v02/images/agent/commands/systemctl-status:running.png)
    </Frame>
  </Tab>
  <Tab title="Inactive">
    ...
    <Frame>
      ![](https://assets.mirurobotics.com/docs/v02/images/agent/commands/systemctl-status:dead.png)
    </Frame>
  </Tab>
</Tabs>
