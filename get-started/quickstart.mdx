...
volumes:
  ...
  To deploy to your target devices, click the ***deploy*** button at the far right of the deployment row. A popup will allow you to select which devices will receive the deployment.
