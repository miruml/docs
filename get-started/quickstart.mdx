...
<AccordionGroup>
  ...
  <img src="/images/repo-name.png" width="400" />
...
<AccordionGroup>
  ...
  <Accordion icon="object-intersect" title="Change a Device's Group" id='move-a-device'>

    To move a device to a different group, first find the device on Group page.

    <img src="/images/group-page.png" />

    Click the ellipsis on the far right and select the "Edit" button.

    <img src="/images/device-row.png" />

    Select the desired group for the device from the options in the top right-hand corner.

    <img src="/images/edit-device-group.png" />
...
volumes:
  ...
  Once the containers have been built, the **Deployment** is staged for you to deploy to your target devices. To deploy to your target devices, click the **deploy** button at the far right of the deployment row.

  <img height="200" src="/images/staged-deployment-update.png" />

  A popup will allow you to select which devices will receive the deployment.
