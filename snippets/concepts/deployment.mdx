A **deployment** represents a specific set of config instances applied to a device.
...
A deployment is an object that ties together **config instances**, **releases**, and **devices**, ensuring that every device runs a valid config instance for its software version.
