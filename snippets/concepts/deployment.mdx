...
Config instances are deployed by the [Miru Agent](/docs/agent/intro), which writes the config instances to a subdirectory of the `/srv/miru/config_instances` directory on the target device.
