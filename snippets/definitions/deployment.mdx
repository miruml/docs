...
Config instances are deployed by the [Miru Agent](/docs/agent/intro), a `systemd` service which writes configs to a subdirectory of the `/srv/miru/config_instances` directory on the target device.
