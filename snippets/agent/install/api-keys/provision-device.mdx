Execute the [provision script](https://github.com/miruml/agent/blob/main/scripts/install/provision.sh), which will create and activate a device using your API key.
