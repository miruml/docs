...
Combining tags with overrides provides a flexible method for rendering configuration data unique to each device and formatted according to a given config schema.