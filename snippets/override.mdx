The second part of a policy are its overrides. An **override** references tag metadata that "overrides" the current evaluation of a policy. Here is a `hardware` override example.

<img height="200" src="/images/core-concepts/hardware-override.png" style={{borderRadius: '7px'}}/>
