<ParamField path="config type" required>
  The config type is a required annotation that identifies the config type to which a schema belongs. Below is the syntax for annotating your schema with the [config type slug](/docs/learn/config-types#param-slug).
